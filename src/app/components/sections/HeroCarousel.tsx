...
export function HeroCarousel({ items }: { items: CarouselItem[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex items-start sm:items-center justify-center relative z-10 pt-20 sm:pt-0">
        <motion.div
          key={currentSlide}
          ...
          className="text-center max-w-3xl px-4 w-full mt-4 sm:mt-0"
        >
