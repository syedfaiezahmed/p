    ...
    >
      ...
      <div className="container mx-auto px-4 h-full flex items-center justify-center relative z-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl mb-6 text-white/90 max-w-2xl mx-auto leading-relaxed">
          ...
          >
            <Link
              href="/contact"
              className="inline-block border-2 border-white bg-gradient-to-r from-[#b62166] to-[#382460] hover:from-[#8a1650] hover:to-[#2a1a4a] text-white px-6 py-3 rounded-md font-semibold text-sm sm:text-base shadow-lg transition-all duration-300 uppercase tracking-wide min-w-[160px] text-center"
            >
