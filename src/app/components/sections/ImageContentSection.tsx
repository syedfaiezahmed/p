...
export function ImageContentSection() {
  return (
    <section className="relative py-8 bg-gradient-to-r from-[#382460cc] to-[#b62166cc] overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-4">
          <motion.div
            ...
            className="w-full lg:w-1/2 h-[200px] flex items-center justify-center"
          >
          ...
          >
            ...
            >
              <Link
                href="/services"
                className="inline-block border-2 border-white bg-gradient-to-r from-[#b62166] to-[#382460] hover:from-[#8a1650] hover:to-[#2a1a4a] text-white px-4 py-2 rounded-lg font-bold text-sm shadow-lg transition-all duration-300 uppercase tracking-wide min-w-[120px] text-center"
              >
                Discover
              </Link>
            </motion.div>
